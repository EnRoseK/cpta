...
import { getSelfStudies, getSelfStudyPage } from '@/api/services';
import { Button, Dropdown, PageHeader, SearchInput } from '@/components/global';
import { siteName } from '@/constants';
import { useLocale } from '@/hooks';
import { ISelfStudy, ISelfStudyPage } from '@/interfaces';
...
export const getStaticProps: GetStaticProps<SelfStudyPageProps> = async ({ locale }) => {
  const [selfStudyPageRes, selfStudiesRes] = await Promise.all([
...
const SelfStudyPage: NextPage<SelfStudyPageProps> = ({ selfStudyPage, selfStudies }) => {
